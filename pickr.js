	...
	(() => {
		...
		function w(t) {
			t = t.match(/^[a-zA-Z]+$/)
				...
				: t;
			const e = { cmyk: /^cmyk\D+([\d.]+)\D+([\d.]+)\D+([\d.]+)\D+([\d.]+)/i, rgba: /^rgba?\D+([\d.]+)(%?)\D+([\d.]+)(%?)\D+([\d.]+)(%?)\D*?(([\d.]+)(%?)|$)/i, hsla: /^hsla?\D+([\d.]+)\D+([\d.]+)\D+([\d.]+)\D*?(([\d.]+)(%?)|$)/i, hsva: /^hsva?\D+([\d.]+)\D+([\d.]+)\D+([\d.]+)\D*?(([\d.]+)(%?)|$)/i, hexa: /^#?(([\dA-Fa-f]{3,4})|([\dA-Fa-f]{6})|([\dA-Fa-f]{8}))$/i },
			...
			t: for (const i in e)
				if ((n = e[i].exec(t)))
					switch (i) {
						...
						case "rgba": {
							let [, t, , e, , s, , , r] = o(n);
							if (((t = "%" === n[2] ? (t / 100) * 255 : t), (e = "%" === n[4] ? (e / 100) * 255 : e), (s = "%" === n[6] ? (s / 100) * 255 : s), (r = "%" === n[9] ? r / 100 : r), t > 255 || e > 255 || s > 255 || r < 0 || r > 1)) break t;
		...
		function C(t) {
			const e = {
					...
					_keyboard(t) {
						...
						if (document.activeElement === o.wrapper) {
							...
							if ("keydown" === n && (s || r || a || l)) {
								let n = 0,
									i = 0;
								"v" === o ? (n = s || r ? 1 : -1) : "h" === o ? (n = s || r ? -1 : 1) : ((i = s ? -1 : a ? 1 : 0), (n = l ? -1 : r ? 1 : 0)), e.update($(e.cache.x + 0.01 * n), $(e.cache.y + 0.01 * i)), t.preventDefault();
					...
					_tapmove(t) {
						...
						"h" !== i && (s.style.left = `calc(${(l / a.width) * 100}% - ${s.offsetWidth / 2}px)`), "v" !== i && (s.style.top = `calc(${(c / a.height) * 100}% - ${s.offsetHeight / 2}px)`), (e.cache = { x: l / a.width, y: c / a.height });
						const p = $(l / a.width),
							u = $(c / a.height);
						switch (i) {
							case "v":
			...
			return i([o.wrapper, o.element], "mousedown", n), i([o.wrapper, o.element], "touchstart", n, { passive: !1 }), i(document, ["keydown", "keyup"], r), e;
		}
		function k(t = {}) {
		...
		const S = { variantFlipOrder: { start: "sme", middle: "mse", end: "ems" }, positionFlipOrder: { top: "tbrl", right: "rltb", bottom: "btrl", left: "lrbt" }, position: "bottom", margin: 8, padding: 0 },
			O = (t, e, o) => {
				...
				return {
					update(t = n) {
						...
						return ((t, e, o) => {
							const { container: n, arrow: i, margin: s, padding: r, position: a, variantFlipOrder: l, positionFlipOrder: c } = { container: document.documentElement.getBoundingClientRect(), ...S, ...o },
							...
							const h = t.getBoundingClientRect(),
								...
								f = { vs: h.left, vm: h.left + h.width / 2 - d.width / 2, ve: h.left + h.width - d.width, hs: h.top, hm: h.bottom - h.height / 2 - d.height / 2, he: h.bottom - d.height },
								[v, b = "middle"] = a.split("-"),
								y = c[v],
								g = l[b],
										...
										if (!(m < b || m + c + r > u)) {
											if (((m -= d[a]), (n -= d[s]), (e.style[a] = `${m}px`), (e.style[s] = `${n}px`), i)) {
												const e = o ? h.width / 2 : h.height / 2,
													r = c / 2,
													u = e > r,
													d = m + { s: u ? r : e, m: r, e: u ? r : c - e }[p],
													f = n + { t: l, b: 0, r: 0, l }[t];
												(i.style[a] = `${d}px`), (i.style[s] = `${f}px`);
											}
											return t + p;
										}
									}
		...
		class E {
			...
			static I18N_DEFAULTS = { "ui:dialog": "color picker dialog", "btn:toggle": "toggle color picker dialog", "btn:swatch": "color swatch", "btn:last-color": "use previous color", "btn:save": "Save", "btn:cancel": "Cancel", "btn:clear": "Clear", "aria:btn:save": "save and close", "aria:btn:cancel": "cancel and close", "aria:btn:clear": "clear and close", "aria:input": "color input field", "aria:palette": "color selection area", "aria:hue": "hue selection slider", "aria:opacity": "selection slider" };
			static DEFAULT_OPTIONS = { appClass: null, theme: "classic", useAsButton: !1, padding: 8, disabled: !1, comparison: !0, closeOnScroll: !1, outputPrecision: 0, lockOpacity: !1, autoReposition: !0, container: "body", components: { interaction: {} }, i18n: {}, swatches: null, inline: !1, sliders: null, default: "#42445a", defaultRepresentation: null, position: "bottom-middle", adjustableNumbers: !0, showAlways: !1, closeWithKey: "Escape" };
			...
			constructor(t) {
				...
				(this._nanopop = O(u, h, { margin: r })), u.setAttribute("role", "button"), u.setAttribute("aria-label", this._t("btn:toggle"));
				const d = this;
			...
			_bindEvents() {
				const { _root: t, options: e } = this,
					o = [
						...
						i([t.palette.palette, t.palette.picker, t.hue.slider, t.hue.picker, t.opacity.slider, t.opacity.picker], ["mousedown", "touchstart"], () => (this._recalc = !0), { passive: !0 }),
					];
				if (!e.showAlways) {
